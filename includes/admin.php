...
{
	if (! current_user_can('manage_options')) {
		wp_die(esc_html_e('You do not have sufficient rights to access this page.', 'mt_post_tracker'));
	}
	...
	if (file_exists($file_path)) {
		...
		echo '<div class="error"><p>' . esc_html_e('The file mt_post_tracker_import_admin.php was not found!', 'mt_post_tracker') . '</p></div>';
	}
}
